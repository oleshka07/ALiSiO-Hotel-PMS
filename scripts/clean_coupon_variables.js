...
files.forEach((file) => {
  ...
  let newContent = content
    .replace(/\bcouponDiscount\b/g, 'offerDiscount')
    .replace(/\bcouponCode\b/g, 'couponCode')
    .replace(/\bshowPromo\b/g, 'showOffer')
    .replace(/\bcouponApplied\b/g, 'offerApplied')
    .replace(/\bcouponError\b/g, 'offerError')
    .replace(/\bapplyingPromo\b/g, 'applyingOffer')
    .replace(/\bhandleApplyPromo\b/g, 'handleApplyOffer')
    .replace(/\burlPromo\b/g, 'urlOffer')
    .replace(/\bsetCouponCode\b/g, 'setCouponCode')
    .replace(/\bsetShowPromo\b/g, 'setShowOffer')
    .replace(/\bsetCouponApplied\b/g, 'setOfferApplied')
    .replace(/\bsetCouponError\b/g, 'setOfferError')
