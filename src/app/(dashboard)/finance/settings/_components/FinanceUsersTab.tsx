...
export default function FinanceUsersTab() {
  ...
  async function handleResetPassphrase(user: FinanceUser) {
    if (!confirm(
      ...
      'При наступному вході у Фінанси людина ОБОВʼЯЗКОВО встановить новий пароль — ' +
      'до того часу фінансові дані їй не покажуться. Права на вкладки та рахунки не зміняться.'
    )) return;
